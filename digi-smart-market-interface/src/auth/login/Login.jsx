          ...
          <div class="col-12 col-md-6 col-xl-7">
            <div class="d-flex justify-content-center text-bg-primary">
              <div class="col-12 col-xl-9">
                ...
                <h2 class="h1 mb-4">Saving the wastage of foods</h2>
                <p class="lead mb-5">
                  We are saving the vegetable and fruites from the wastage, By
                  sale the closest expiery products with giving some offers or
                  providing them as free.
                </p>
                {/* <div class="text-endx">
                  <svg
